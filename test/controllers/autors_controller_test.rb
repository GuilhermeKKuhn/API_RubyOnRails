...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference('Autor.count') do
      post autors_url, params: { autor: { nascimento: @autor.nascimento, nome: @autor.nome } }, as: :json
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { nascimento: @autor.nascimento, nome: @autor.nome } }, as: :json
    assert_response 200
  end
